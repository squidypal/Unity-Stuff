...
public class TextureToLightManager2D : MonoBehaviour
{
    [System.Serializable]
    ...
    void ProcessAllLights()
    {
        foreach (var mapping in lightMappings)
        {
            ...
            else
            {
               ...
               // mapping.targetLight.intensity = sampledColor.grayscale > 0.01f ? mapping.targetLight.intensity : 0f;
    ...
    void UpdateSmoothTransitions()
    {
        foreach (var mapping in lightMappings)
        {
            ...
            if (useSmoothTransition && mapping.transitionProgress < 1.0f && mapping.targetLight != null)
            {
               ...
               // mapping.targetLight.intensity = currentColor.grayscale > 0.01f ? mapping.targetLight.intensity : 0f;
